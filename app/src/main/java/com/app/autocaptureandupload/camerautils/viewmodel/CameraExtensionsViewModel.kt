...
import com.app.autocaptureandupload.camerautils.model.CameraUiState
    ...
    fun initializeCamera() {
        viewModelScope.launch {
            ...
            val newCameraUiState = currentCameraUiState.copy(
                cameraState = com.app.autocaptureandupload.camerautils.model.CameraState.READY,
...
//                    )
    ...
    private fun uploadPhoto(photoFile: File) {
        apiViewModel.uploadImage(photoFile)
    }
